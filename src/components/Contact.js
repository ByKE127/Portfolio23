      ...
      <div className="contact-container">
        ...
        <div className="container page-title text-center">
          ...
          <span className="title-head-subtitle">
            I’m always open to freelance or contract work!
          </span>
        </div>
        {/* Main Heading Ends */}
              ...
              <ul className="custom-list">
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">ByKevinEdwards@gmail.com</span>
                  </h6>
                </li>
                {/*}
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content"><a href="www.linkedin.com/in/kedward3" target="_blank">LinkedIn</a>
</span>
                  </h6>
                </li>
                <li>
...
*/}
            ...
            <div className="col-12 col-md-8 col-xl-8 rightside">
              <p>
                Have a project or idea you want to come to life? Fill out the form below
